...
import { downloadProjectFile, listFiles, uploadProjectFile } from "../services/files";
import { addProjectMember, deleteGitHubRepository, listProjectMembers, removeProjectMember, retryGitHubRepositoryCreation, rewrapProjectMemberKey, searchProfiles, updateProject } from "../services/projects";
...
export function ProjectSettingsPage() {
  ...
  const deleteRepo = useMutation({ mutationFn: () => deleteGitHubRepository(project.id, confirmation), onSuccess: async () => { setDangerOpen(false); await queryClient.invalidateQueries({ queryKey: ["project", project.id] }); } });
